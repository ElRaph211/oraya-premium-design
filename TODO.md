...
- [ ] **Temoignages clients** · Ajouter 2-3 citations clients (nom + role + citation courte) · fort impact conversion, envoie moi les texte et comment tu veux qu'il soit disposé et je me mets au travail.
...
- [ ] **Formulaire contact** · Le `mailto:` ne fonctionne pas sur mobile sans client mail. Alternatives : utiliser Tally 
...
- [ ] **Compresser les images lourdes** via [squoosh.app](https://squoosh.app) (cible < 200 Ko chacune)
  ...
  - `etape_4.png` · 993 Ko
  - `etape_2.png` · 499 Ko
- [ ] **Alignement logo navbar** · Ajustement fin (`-mt-1`) en place, mettre plus sur la gauche afin qu'il soit aligné sur le corp du text plus bas.
